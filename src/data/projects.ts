...
export const works = [
  {
    ...
    architectureChips: [
      { label: 'Model', value: 'Gemini 2.0 Flash plus Gemini Embedding 001 and function declarations' },
      { label: 'Context', value: 'Supabase profile, projects, products, completeness score, and RAG chunks' },
      { label: 'Orchestration', value: 'Classify intent, retrieve context, verify links, propose tool-call edits' },
      { label: 'Governance', value: 'Guest tools disabled; profile writes require before/after review cards' },
      { label: 'Human', value: 'Profile owner protects public identity, credibility, and tone before publishing' },
    ],
  ...
  },
  {
    ...
    architectureChips: [
      { label: 'Model', value: 'Gemini audio transcription/generation plus Imagen watercolor generation' },
      { label: 'Context', value: 'Dream transcript plus Jungian, Persian, Egyptian, and Japanese Dream Wiki' },
      { label: 'Orchestration', value: 'Record audio, transcribe, review text, then run parallel generation jobs' },
      { label: 'Governance', value: 'Quotas, StoreKit entitlements, RLS, cost limiter, cloud-audio deletion' },
      { label: 'Human', value: 'Design preserves fragile recall, private reflection, and symbolic interpretation' },
    ],
  ...
  },
  {
    ...
    architectureChips: [
      { label: 'Model', value: 'Local Gemma/MLX triage, Gemini strategy, and weekly quantum batch layer' },
      { label: 'Context', value: 'Five signal pipelines, Knowledge Graph, source trust, assets, and outcomes' },
      { label: 'Orchestration', value: 'Ingest, normalise, score, reason, paper-trade, then review signals' },
      { label: 'Governance', value: 'Trust scores, risk gates, paper proof ledger, append-only logs, approvals' },
      { label: 'Human', value: 'Strategy judgment weighs uncertainty, restraint, and capital-risk appetite' },
    ],
  ...
  },
  {
    ...
    architectureChips: [
      ...
      { label: 'Context', value: 'Compressed Shopify catalog, product handles, chat history, and locations' },
      { label: 'Orchestration', value: 'Inject catalog, return itinerary JSON, show products, hand off to WhatsApp' },
      { label: 'Governance', value: 'Catalog-only constraints, JSON mode, malformed-output checks, concierge boundary' },
      { label: 'Human', value: 'Luxury-service judgment keeps taste, empathy, and accountability with concierge' },
    ],
  ...
  },
  {
    ...
    architectureChips: [
      { label: 'Model', value: 'Gemini 2.5 Flash for descriptions and categories, with Vision OCR support' },
      { label: 'Context', value: 'TMDB metadata, personal taxonomy, poster/trailer data, existing library' },
      { label: 'Orchestration', value: 'Title input triggers metadata, copy, category, trailer, poster check, save' },
      { label: 'Governance', value: 'Constrained taxonomy, poster OCR, duplicate cleanup, admin correction path' },
      { label: 'Human', value: 'Personal taste decides atmosphere, canon, and what feels worth watching' },
    ],
  ...
  },
  {
    ...
    architectureChips: [
      { label: 'Model', value: 'Gemini 2.5 Flash for OCR, extraction, scoring, categorisation, sorting' },
      { label: 'Context', value: 'Source URLs, captions, transcripts, screenshots, OCR, and category rules' },
      { label: 'Orchestration', value: 'Inspect, route, compose, self-assess, categorise, sort, export .docx' },
      { label: 'Governance', value: 'URL sanitisation, rate limits, failure logs, quality scores, retry bounds' },
      { label: 'Human', value: 'User judgment decides what knowledge is worth preserving and importing' },
    ],
...
export const toolsAndSystems = [
  ...
  },
  {
    ...
    modelLayer: 'Gemini 2.0 Flash with function declarations plus Gemini Embedding 001.',
    contextLayer: 'Live profile state, curated knowledge chunks, query intent, and reranking.',
    orchestrationLayer: 'Classify intent, retrieve, verify links, parse tool calls, review edits.',
    governanceLayer: 'Guest mode blocks writes; mutation prompts require confirmable review cards.',
    humanLayer: 'Owner judgment shapes public identity, taste, and credibility before commit.',
  ...
  },
  {
    ...
    modelLayer: 'Gemini audio transcription/generation plus Imagen watercolor generation.',
    contextLayer: 'Editable dream transcript plus curated dream-tradition wiki content.',
    orchestrationLayer: 'Record, transcribe, review source text, run generation jobs, save dream.',
    governanceLayer: 'Dream quotas, StoreKit checks, RLS, cost limiter, cloud-audio deletion.',
    humanLayer: 'Empathy for fragile recall guides privacy, pacing, and symbolic interpretation.',
  ...
  },
  {
    ...
    contextLayer: 'Compressed Shopify catalog, product handles, chat history, and locations.',
    orchestrationLayer: 'Request intake, catalog injection, itinerary JSON, product carousel, handoff.',
    governanceLayer: 'Catalog-only constraints, JSON mode, malformed-output checks, concierge boundary.',
    humanLayer: 'Concierge taste and accountability stay responsible for the final booking.',
  ...
  },
  {
    ...
    modelLayer: 'Gemini 2.5 Flash for OCR, extraction, scoring, categorisation, sorting.',
    contextLayer: 'Source URLs, captions, transcripts, screenshots, OCR, and category rules.',
    orchestrationLayer: 'Inspect, route, compose, self-assess, categorise, sort, export .docx.',
    governanceLayer: 'URL sanitisation, rate limits, failure logs, quality scores, retry bounds.',
    humanLayer: 'User judgment decides what knowledge is worth preserving and importing.',
  ...
  },
  {
    ...
    modelLayer: 'No generation model; dashboard tracks provider/model usage from other products.',
    contextLayer: 'Per-call product, feature, user segment, request type, latency, and cost metadata.',
    orchestrationLayer: 'Log calls, aggregate usage, compare providers, detect anomalies, review.',
    governanceLayer: 'Cost caps, latency thresholds, retry/failure visibility, spend alerts.',
  ...
  },
  {
    ...
    contextLayer: 'Curated source material, chunks, metadata, embeddings, ranking signals.',
    orchestrationLayer: 'Ingest, embed, retrieve, rerank, verify sources, inject, answer, log.',
    governanceLayer: 'Deduping, retrieval thresholds, link verification, injection handling.',
    humanLayer: 'Corpus curation decides which sources deserve authority in the product.',
