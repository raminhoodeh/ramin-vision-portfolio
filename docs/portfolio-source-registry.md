...
- Fitness and human performance: Level 3 Personal Training qualification, confirmed by Ramin after the initial scrape. Use as domain context for fitness, gym, coaching, health-behaviour, and human-performance product questions while certificate proof remains pending.
...
- Whether to include Nuclio, Renewable Energy Finance, and other older nsso-profile qualifications.
