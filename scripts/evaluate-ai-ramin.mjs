...
const SOFT_CTAS_BY_QUESTION_TYPE = {
  conversation_open: [],
  portfolio_overview: ['show_evidence', 'analyze_role_fit', 'compare_projects'],
  factual_capability: ['show_evidence', 'ask_stronger_proof', 'analyze_role_fit'],
  role_fit: ['draft_hiring_brief', 'generate_interview_questions', 'show_evidence'],
  behavioral_example: ['generate_interview_questions', 'show_evidence', 'ask_stronger_proof'],
  product_judgment: ['turn_into_mvp_plan', 'show_risks', 'compare_projects'],
  tradeoff_or_prioritisation: ['show_risks', 'compare_projects', 'show_evidence'],
  weakness_or_gap: ['ask_stronger_proof', 'generate_interview_questions', 'show_evidence'],
  first_90_days: ['draft_hiring_brief', 'generate_interview_questions', 'show_evidence'],
  interview_coaching: ['generate_interview_questions', 'show_evidence', 'ask_stronger_proof'],
  hiring_brief: ['show_evidence', 'ask_stronger_proof'],
